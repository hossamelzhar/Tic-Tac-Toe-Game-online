...
# -*- coding: utf-8 -*-
"""
Created on Wed May  1 19:03:15 2019
...
lb1=tk.Label(window,text='You : O',font=('Helvetica','15'))
lb1.grid(row=0,column=0)
lb2=tk.Label(window,text='Client : X',font=('Helvetica','15'))
lb2.grid(row=1,column=0)
lb3=tk.Label(window,text="start the game",font=('Helvetica','15'))
...
def recv_func():
    while True:
         x=int(c.recv(2048).decode('utf-8'))
         global turn
         turn=1
         global flag
         flag+=1
         ...
         if x==9:
             ...
             lb3['text']=("it's your turn")
         if x==11:
             messagebox.showinfo(message='Hard luck, Client is the winner')
             flag=1
             turn=1
             btn1['text']=''
             btn2['text']=''
